...
class detelsblood extends StatefulWidget {
  QueryDocumentSnapshot doctors;
  detelsblood({required this.doctors});

  @override
  State<detelsblood> createState() => _detelsbloodState();
}

class _detelsbloodState extends State<detelsblood> {
  @override
